...
| Antonio Gamber ![alt text](/docs/img/Persona2.jpg) |   42  |  Professor de Matemática   | WhatsApp, Instagram, Linkedin, Aplicativos de Banco           | Fazer uma especialização numa faculdade no exterior. | Ver que a média das notas dos alunos está baixa. | Gosta de ler e ouvir música. |
